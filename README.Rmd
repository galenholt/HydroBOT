...
[![R-CMD-check](https://github.com/galenholt/HydroBOT/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/galenholt/HydroBOT/actions/workflows/R-CMD-check.yaml) [![Codecov test coverage](https://codecov.io/gh/galenholt/HydroBOT/graph/badge.svg)](https://app.codecov.io/gh/MDBAuth/HydroBOT)
...
See the [HydroBOT documentation website](https://mdbauth.github.io/HydroBOT_website/) for a full demonstration and the [template repo](https://github.com/MDBAuth/toolkit_use) for a bare-bones project structure.
