...
if REBUILD_DATA:
    ...
    base.query('Date > @start15').filter(items = minigauges).to_csv(os.path.join(repo, dataoutdir, 'testsmall', 'base', 'base.csv'))
    down4.query('Date > @start15').filter(items = minigauges).to_csv(os.path.join(repo, dataoutdir, 'testsmall', 'down4', 'down4.csv'))
    up4.query('Date > @start15').filter(items = minigauges).to_csv(os.path.join(repo, dataoutdir, 'testsmall', 'up4', 'up4.csv'))
