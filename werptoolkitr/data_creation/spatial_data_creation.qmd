...
If we comment out the knitr statement, this will build to the Quarto project directory, NOT the R project directory. And since this is nested in the repo, that's not the same place, and its not what we want.
...
Set the data dir to make that easy to change. This uses the *Quarto* project directory, *not* the *R* project directory, and so
