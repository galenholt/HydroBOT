...
# Also have to turn of caching and delete _cache directories or it gets really
# upset.
devtools::load_all()
...
if (REBUILD_DATA) {
  ...
  usethis::use_data(basin)
  usethis::use_data(resource_plan_areas)
  usethis::use_data(sdl_units)
  usethis::use_data(bom_basin_gauges)
  usethis::use_data(cewo_valleys)
}
