...
```{r}
ewr_summary <- prep_run_save_ewrs_R(scenario_dir, output_dir, model_format, climate, 
...
```{r}
ewr_out <- prep_run_save_ewrs_R(scenario_dir, output_dir, model_format, climate, 
