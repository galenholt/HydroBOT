...
test_that("combos", {
  ...
  system.time({
    assessedmin <- control_achievement(
      datain,
      year_roll = 3,
      k_freq = 20,
      k_inter = 50,
  ...
  system.time({
    assessedmax <- control_achievement(
      datain,
      year_roll = 3,
      k_freq = 20,
      k_inter = 50,
  ...
  system.time({
    assessedgm <- control_achievement(
      datain,
      year_roll = 3,
      k_freq = 20,
      k_inter = 50,
