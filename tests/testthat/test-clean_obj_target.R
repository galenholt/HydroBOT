...
qcs <- c(
  system.file("data-raw/causal_networks/unknown/Target_species_per_PU_Murray.csv", package = "werptoolkitr"),
...
test_that("produces desired format for obj-target", {
  ...
  expect_equal(names(obj2target), c(
    "PlanningUnitID", "planning_unit_name", "LTWPShortName", "env_obj",
