...
test_that("character sceneorder works", {
  ...
  expect_equal(levels(test_prep$data$scenario), c('down4_down4', 'base_base', 'up4_up4'))
})

test_that("factor sceneorder works", {
  scenarios <- tibble::tibble(scenario = c('down4_down4', 'base_base', 'up4_up4'), delta = c(1, 0.25, 4))
