...
test_that("list of ~ functions works", {
  aggchar1 <- general_aggregate(mtcars,
    groupers = cyl, aggCols = disp,
  ...
  aggchar2 <- general_aggregate(mtcars,
    groupers = c(cyl, carb), aggCols = c(disp, wt),
...
test_that("tidyselect for groupers and aggCols works", {
  ...
  aggchar <- general_aggregate(mtcars,
...
test_that("failmissing works", {
  ...
  # explicit TRUE
  expect_error(aggchar1 <- general_aggregate(mtcars,
    groupers = c("cyl", "not_a_col"),
    aggCols = c("disp", "also_not"),
...
test_that("dots pass", {
  ...
  # package.
  expect_warning(aggchar1 <- general_aggregate(mtna,
    groupers = cyl, aggCols = disp,
...
test_that("handling data-variables as arguments works with rlang::quo", {
  ...
  anlist <- rlang::quo(list(
    mean = \(x) mean(x, na.rm = TRUE),
    wm = \(x) weighted.mean(x, gear, na.rm = TRUE)
  ))

  aggchare <- general_aggregate(mtcars,
    groupers = cyl, aggCols = disp,
    funlist = anlist
  )
  ...
  aggchart <- general_aggregate(mtcars,
    groupers = cyl, aggCols = disp,
    funlist = rlang::quo(list(
  ...
  aggcharte <- general_aggregate(mtcars,
    groupers = cyl, aggCols = disp,
    funlist = anlistt
  )
  ...
  anlistb <- rlang::quo(list(
    mean = mean,
    wm = \(x) weighted.mean(x, gear, na.rm = TRUE)
  ))

  aggchareb <- general_aggregate(mtcars,
    groupers = cyl, aggCols = disp,
    funlist = anlistb
  )
  ...
  anlistc <- rlang::quo(list(
    mean = "mean",
    wm = \(x) weighted.mean(x, gear, na.rm = TRUE)
  ))

  expect_error(aggcharec <- general_aggregate(mtcars,
    groupers = cyl, aggCols = disp,
    funlist = anlistc
  ))
  ...
  expect_error(aggcharwe <- general_aggregate(mtcars,
    groupers = cyl, aggCols = disp,
  ...
  aggcharwe2 <- general_aggregate(mtcars,
    groupers = cyl, aggCols = disp,
    funlist = l2
  )
...
test_that("handling data-variables as arguments works without wrapping with rlang::quo", {
  ...
  aggcharwe <- general_aggregate(mtcars,
    groupers = cyl, aggCols = disp,
